...
def _hashfunc(x):
    hash_md5 = hashlib.md5(x)
    hash_value = hash_md5.hexdigest()
    print(convert_md5(hash_value), len(convert_md5(hash_value)))
    int_16char = int(hash_value, 16) #convert
    ...
    def build_by_features(self, features):
        ...
        for f in features:
            if isinstance(f, basestring):
                # creat hash value for every word(feature)
